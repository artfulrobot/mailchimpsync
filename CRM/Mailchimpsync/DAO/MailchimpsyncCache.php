 ...
 * (GenCodeChecksum:f7596b44e14174ae7930f1a9fb2afc52)
 */
...
class CRM_Mailchimpsync_DAO_MailchimpsyncCache extends CRM_Core_DAO {
  ...
  /**
   * Snapshot info about groups the contact has been added/removed since certain date, used by sync
   *
   * @var text
   */
  public $civicrm_groups;
  ...
  /**
   * ok|todo|live_sub|live_unsub|live_data|redo|fail
   *
   * @var string
   */
  public $sync_status;
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'mailchimp_data' => [
          ...
          'description' => CRM_Mailchimpsync_ExtensionUtil::ts('PHP serialized data'),
        ...
        'civicrm_groups' => [
          ...
          'title' => CRM_Mailchimpsync_ExtensionUtil::ts('Civicrm Groups'),
          'description' => CRM_Mailchimpsync_ExtensionUtil::ts('Snapshot info about groups the contact has been added/removed since certain date, used by sync'),
          'where' => 'civicrm_mailchimpsync_cache.civicrm_groups',
          'table_name' => 'civicrm_mailchimpsync_cache',
          'entity' => 'MailchimpsyncCache',
          'bao' => 'CRM_Mailchimpsync_DAO_MailchimpsyncCache',
          'localizable' => 0,
        ...
        'sync_status' => [
          ...
          'description' => CRM_Mailchimpsync_ExtensionUtil::ts('ok|todo|live_sub|live_unsub|live_data|redo|fail'),
          'maxlength' => 10,
